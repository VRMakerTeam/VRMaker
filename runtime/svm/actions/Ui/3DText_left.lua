...
local txt_3DText = {en_US="3DText_left", zh_CN="3D文本(左对齐)", tw="3D文字靠左對齊", pt="Texto 3D alinhar à esquerda", fr="Texte 3D aligner à gauche", it="Testo 3D allineato a sinistra", sp="Alinear el texto 3D a la izquierda", jp="3Dテキストを左揃え", kr="3D 텍스트 왼쪽 정렬", de="Text links ausrichten", ru="Выровнять текст по левому краю"}
