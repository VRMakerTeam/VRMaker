...
local txt_3DText = {en_US="3DText_Right", zh_CN="3D文本(右对齐)", tw="3D文本右對齊", pt="Texto 3D alinhar à direita", fr="Texte 3D aligner à droite", it="Testo 3D allineato a destra", sp="Texto 3D alinear a la derecha", jp="3Dテキストを右揃え", kr="3D 텍스트 정렬 오른쪽", de="Rechts ausrichten", ru="Выровнять право"}
