...
local txt_3DText = {en_US="3DText_Up", zh_CN="3D文本(上对齐)", tw="3D文字向上對齊", pt="Texto 3D alinhar", fr="Texte 3D aligner", it="Testo 3D allineato", sp="Alinear el texto en 3D", jp="3Dテキストが揃う", kr="3D 텍스트 정렬", de="Oben ausrichten", ru="Выровнять выше"}
