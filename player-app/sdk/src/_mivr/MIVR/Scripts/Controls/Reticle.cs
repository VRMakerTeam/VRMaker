//-----------------------------------------------------------------------
// <copyright file="Reticle.cs" company="XiaoMi Corporation">
//     All rights reserved.
// </copyright>
//-----------------------------------------------------------------------
...
public class Reticle : MonoBehaviour
{
    ...
    {
        MIGazeInputModule.GazePointer = this;
    }
    ...
    {
        if (MIGazeInputModule.GazePointer == this)
        {
            MIGazeInputModule.GazePointer = null;
        }
    }
    ...
    private void UpdateDiameters()
    {
        ...
        if (this.reticleInnerAngle < Reticle.KReticleMinInnerAngle)
        {
            this.reticleInnerAngle = Reticle.KReticleMinInnerAngle;
        }

        if (this.reticleOuterAngle < Reticle.KReticleMinOuterAngle)
        {
            this.reticleOuterAngle = Reticle.KReticleMinOuterAngle;
        }

        float inner_half_angle_radians = Mathf.Deg2Rad * this.reticleInnerAngle * Reticle.KReticleScale;
        float outer_half_angle_radians = Mathf.Deg2Rad * this.reticleOuterAngle * Reticle.KReticleScale;
        ...
        this.materialComp.SetFloat("_InnerDiameter", this.reticleInnerDiameter * this.reticleDistanceInMeters * Reticle.KReticleScale);
        this.materialComp.SetFloat("_OuterDiameter", this.reticleOuterDiameter * this.reticleDistanceInMeters * Reticle.KReticleScale);
    ...
    private void SetGazeTarget(Vector3 target)
    {
        ...
        this.reticleInnerAngle = Reticle.KReticleMinInnerAngle + Reticle.KReticleGrowthAngle;
        this.reticleOuterAngle = Reticle.KReticleMinOuterAngle + Reticle.KReticleGrowthAngle;
    }
}