...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(SVMAPI.FinishDelegate))
			{
			    return new SVMAPI.FinishDelegate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(SVMAPI.OnUpdate))
			{
			    return new SVMAPI.OnUpdate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(SVMAPI.OnExecute))
			{
			    return new SVMAPI.OnExecute(__Gen_Delegate_Imp1);
			}
