...
namespace Battlehub.RTHandles
{
    ...
    public enum RuntimeCameraEuler
    {
        Target,
        Head
    }
    ...
    public delegate void RuntimeCameraEulerChanged();
    public static class RuntimeTools
    {
        ...
        public static event RuntimeCameraEulerChanged CameraEulerChanged;

        private static RuntimeTool m_current;
        private static RuntimePivotRotation m_pivotRotation;
        private static RuntimeCameraEuler m_cameraEuler;
        ...
        public static RuntimeCameraEuler CameraEuler
        {
            get { return m_cameraEuler; }
            set
            {
                if (m_cameraEuler != value)
                {
                    m_cameraEuler = value;
                    if (CameraEulerChanged != null)
                    {
                        CameraEulerChanged();
                    }
                }
    ...
    {
        public delegate void OnHandleDropDelegate(BaseHandle _handle);
        public static OnHandleDropDelegate OnPositionHandleDrop;
        public static OnHandleDropDelegate OnRotationHandleDrop;
        public static OnHandleDropDelegate OnScaleHandleDrop;
